<?php  //[STAMP] 6342ece0ab363deac468ef899ea389e6
...
trait FunctionalTesterActions
{
     ...
     *
     *
     * @see \Helper\Functional::runNpmCommand()
     */
    public function runNpmCommand($command) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('runNpmCommand', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Functional::findAndOpenLink()
     */
    public function findAndOpenLink($css, $attribute) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('findAndOpenLink', func_get_args()));
    }
